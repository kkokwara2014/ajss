        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container box_1620">
                ...
                <a class="navbar-brand logo_h" href="{{ route('index') }}"
                    style="color: whitesmoke; font-weight: bold"><img class="img-responsive"
                        src="{{asset('bootstrap_assets/img/logoReady.png')}}" alt="" width="70" height="70"></a>
                ...
                <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                    <ul class="nav navbar-nav menu_nav ml-auto">
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item"><a class="nav-link" href="{{ route('ajssaifpu') }}">AJSSAIFPU</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('authorship') }}">Authorship</a>
                                </li>
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('plagiarism') }}">Plagiarism</a>
                                </li>
                        ...
                        <li class="nav-item submenu dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="{{ route('review.process') }}">Review
                                        Process</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('guidelines') }}">Guidelines</a>
                                </li>
                                <li class="nav-item"><a class="nav-link" href="{{ route('payment.mode') }}">Mode
                                        of Payment</a></li>
                                {{-- <li class="nav-item"><a class="nav-link"
                                        href="{{ route('paper.status') }}">Check Paper Status</a>
                        </li> --}}
                    </ul>
                    </li>
                    <li class="nav-item submenu dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item"><a class="nav-link" href="{{ route('download.more') }}">More
                                    Documents</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item submenu dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="nav-item"><a class="nav-link" href="{{ route('callforpaper') }}">Call
                                    for Conference</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('futureconference') }}">Future
                                    Conference</a></li>
                        </ul>
                    </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="nav-item"><a href="{{ route('submit.paper.form') }}" class="tickets_btn">Submit
                                Paper</a></li>
                    </ul>
