            ...
            <div class="col-lg-3 col-md-6 col-sm-6 offset-lg-1">
                <div class="single-footer-widget instafeed">
                    ...
                    <ul class="list instafeed d-flex flex-wrap">
                        <li><img src="{{asset('bootstrap_assets/img/instagram/Image-01.jpg')}}"></li>
                        <li><img src="{{asset('bootstrap_assets/img/instagram/Image-02.jpg')}}"></li>
                        <li><img src="{{asset('bootstrap_assets/img/instagram/Image-03.jpg')}}"></li>
                        <li><img src="{{asset('bootstrap_assets/img/instagram/Image-04.jpg')}}"></li>
                        <li><img src="{{asset('bootstrap_assets/img/instagram/Image-05.jpg')}}"></li>
                        <li><img src="{{asset('bootstrap_assets/img/instagram/Image-06.jpg')}}"></li>
                        <li><img src="{{asset('bootstrap_assets/img/instagram/Image-07.jpg')}}"></li>
                        <li><img src="{{asset('bootstrap_assets/img/instagram/Image-08.jpg')}}"></li>
                    </ul>
                </div>
            </div>	
        </div>
